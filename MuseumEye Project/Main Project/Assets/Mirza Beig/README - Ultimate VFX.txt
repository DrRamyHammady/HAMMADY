...
- Note that the new particle forces components in Ultimate VFX are NOT the same as the new modules in Unity 5.5. These will not be removed or deprecated since they offer new functionality that Unity/Shuriken doesn't have natively.
