...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        //public bool OpenInteraction = false;
        /// <summary>
        ...
        protected virtual void Update()
        {
                ...
                if (IsBeingPlaced)
                {
                    ...
                    //Vector3 proposedPosition = gameObjectBeingMoved.transform.position;//  headPosition + gazeDirection * 2.0f;
